    ...
    public partial class Databaseinitialization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignmentSteps_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryAssignments", x => new { x.AssignmentId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentSteps_AssignmentId",
